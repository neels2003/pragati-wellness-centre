...
<div className="absolute bottom-20 left-20 w-72 h-72 bg-white/5 rounded-full blur-3xl" />
          ...
          <div className="animate-slide-up">
            ...
            <div className="flex items-center gap-6 mb-8">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-white/50 mt-1">Websites Views</p>
              </div>
              <div className="w-px h-10 bg-white/10" />
              <div className="text-center">
      ...
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=1920&q=80')] bg-cover bg-center opacity-18 mix-blend-overlay pointer-events-none" />
        <div className="max-w-6xl mx-auto px-6">
          <AnimatedSection className="text-center mb-14">
